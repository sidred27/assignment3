 ...
 * @author  Anugu Team
 */
class Anugu_Gallery_Notice_Admin {
    ...
    public function __construct() {
        ...
        // Populate $notices
        $this->notices = get_option( 'anugu_gallery_notices' );
    ...
    public function dismiss( $notice ) {
        ...
        update_option( 'anugu_gallery_notices', $this->notices );
    ...
    /**
     * Displays an inline notice with some Anugu styling.
     *
     * @since 1.3.5
     *
     * @param string    $notice             Programmatic Notice Name
    ...
    public function display_inline_notice( $notice, $title, $message, $type = 'success', $button_text = '', $button_url = '', $is_dismissible = true ) {
        ...
        ?>
        <div class="anugu-notice <?php echo $type . ( $is_dismissible ? ' is-dismissible' : '' ); ?>" data-notice="<?php echo $notice; ?>">
            <?php
            // Title
            if ( ! empty ( $title ) ) {
                ?>
                <p class="anugu-intro"><?php echo $title; ?></p>
                <?php
            }
            ...
            if ( $is_dismissible ) {
                ...
                <button type="button" class="notice-dismiss">
                    <span class="screen-reader-text">
                        <?php _e( 'Dismiss this notice', 'anugu-gallery-lite' ); ?>
                    </span>
                </button>
                <?php
            }
     ...
     * @since 1.3.5
     *
     * @return object The Anugu_Gallery_Notice_Admin object.
     */
    public static function get_instance() {

        if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Anugu_Gallery_Notice_Admin ) ) {
            self::$instance = new Anugu_Gallery_Notice_Admin();
        }
...
$anugu_gallery_notice_admin = Anugu_Gallery_Notice_Admin::get_instance();