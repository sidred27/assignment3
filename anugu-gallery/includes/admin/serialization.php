 ...
 * @author  Anugu Team
 */
class Anugu_Serialization_Admin {
     ...
     * @since 1.3.1.6
     *
     * @return object The Anugu_Serialization_Admin object.
     */
    public static function get_instance() {

        if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Anugu_Serialization_Admin ) ) {
            self::$instance = new Anugu_Serialization_Admin();
        }
...
$anugu_serialization_admin = Anugu_Serialization_Admin::get_instance();