...
class Anugu_Gallery_Media {
    ...
    */
     ...
     * @since 1.0.0
     *
     * @return object The Anugu_Gallery_Media object.
     */
    public static function get_instance() {

        if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Anugu_Gallery_Media ) ) {
            self::$instance = new Anugu_Gallery_Media();
        }
...
$anugu_gallery_media = Anugu_Gallery_Media::get_instance();