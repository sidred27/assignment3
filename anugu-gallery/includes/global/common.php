...
class Anugu_Gallery_Common {
    ...
    public function get_columns() {
        ...
        $columns = array(
            array(
                'value' => '0',
                'name'  => __( 'Automatic', 'anugu-gallery-lite' )
            ),
            array(
                'value' => '1',
                'name'  => __( 'One Column (1)', 'anugu-gallery-lite' )
            ),
            array(
                'value' => '2',
                'name'  => __( 'Two Columns (2)', 'anugu-gallery-lite' )
            ),
            array(
                'value' => '3',
                'name'  => __( 'Three Columns (3)', 'anugu-gallery-lite' )
            ),
            array(
                'value' => '4',
                'name'  => __( 'Four Columns (4)', 'anugu-gallery-lite' )
            ),
            array(
                'value' => '5',
                'name'  => __( 'Five Columns (5)', 'anugu-gallery-lite' )
            ),
            array(
                'value' => '6',
                'name'  => __( 'Six Columns (6)', 'anugu-gallery-lite' )
            )
        );

        return apply_filters( 'anugu_gallery_columns', $columns );
    ...
    public function get_gallery_themes() {
        ...
        $themes = array(
            array(
                'value' => 'base',
                'name'  => __( 'Base', 'anugu-gallery-lite' ),
                'file'  => $this->base->file
            )
        );

        return apply_filters( 'anugu_gallery_gallery_themes', $themes );
    ...
    public function get_justified_gallery_themes() {
        ...
        $themes = array(
            array(
                'value' => 'normal',
                'name'  => __( 'Normal', 'anugu-gallery-lite' ),
                'file'  => $this->base->file
            )
        );

        return apply_filters( 'anugu_gallery_justified_gallery_themes', $themes );
    ...
    public function get_display_description_options() {
        ...
        $descriptions = array(
            array(
                'name'  => __( 'Do not display', 'anugu-gallery-lite' ),
                'value' => 0,
            ),
            array(
                'name'  => __( 'Display above galleries', 'anugu-gallery-lite' ),
                'value' => 'above',
            ),
            array(
                'name'  => __( 'Display below galleries', 'anugu-gallery-lite' ),
                'value' => 'below',
            ),
        );

        return apply_filters( 'anugu_gallery_display_description_options', $descriptions );
    ...
    public function get_sorting_options() {
        ...
        $options = array(
            array(
                'name'  => __( 'No Sorting', 'anugu-gallery-lite' ),
                'value' => 0,
            ),
            array(
                'name'  => __( 'Random', 'anugu-gallery-lite' ),
                'value' => 1, // Deliberate, as we map the 'random' config key which was a true/false
            ),
            array(
                'name'  => __( 'Published Date', 'anugu-gallery-lite' ),
                'value' => 'date',
            ),
            array(
                'name'  => __( 'Filename', 'anugu-gallery-lite' ),
                'value' => 'src',
            ),
            array(
                'name'  => __( 'Title', 'anugu-gallery-lite' ),
                'value' => 'title',
            ),
            array(
                'name'  => __( 'Caption', 'anugu-gallery-lite' ),
                'value' => 'caption',
            ),
            array(
                'name'  => __( 'Alt', 'anugu-gallery-lite' ),
                'value' => 'alt',
            ),
            array(
                'name'  => __( 'URL', 'anugu-gallery-lite' ),
                'value' => 'link',
            ),
        );

        return apply_filters( 'anugu_gallery_sorting_options', $options );
    ...
    public function get_sorting_directions() {
        ...
        $directions = array(
            array(
                'name'  => __( 'Ascending (A-Z)', 'anugu-gallery-lite' ),
                'value' => 'ASC',
            ),
            array(
                'name'  => __( 'Descending (Z-A)', 'anugu-gallery-lite' ),
                'value' => 'DESC',
            ),
        );

        return apply_filters( 'anugu_gallery_sorting_directions', $directions );
...
//            array(
//                'value' => 'base_dark',
//                'name'  => __( 'Base (Dark)', 'anugu-gallery-lite' ),
//                'file'  => $this->base->file
//            ),
            array(
                'value' => 'base',
                'name'  => __( 'Legacy', 'anugu-gallery-lite' ),
                'file'  => $this->base->file
            )
        );

        return apply_filters( 'anugu_gallery_lightbox_themes', $themes );
     ...
     *
     * @param   bool    $wordpress_only     WordPress Only (excludes the default and anugu_gallery_random options)
    ...
    public function get_image_sizes( $wordpress_only = false ) {
        ...
        if ( ! $wordpress_only ) {
            $sizes = array(
                array(
                    'value'  => 'default',
                    'name'   => __( 'Default', 'anugu-gallery-lite' ),
                )
            );
        }
        ...
        $sizes[] = array(
            'value' => 'full',
            'name'  => __( 'Original Image', 'anugu-gallery' ),
        );

        return apply_filters( 'anugu_gallery_image_sizes', $sizes );
    ...
    public function get_title_displays() {
        ...
        $displays = array(
            array(
                'value' => 'float',
                'name'  => __( 'Float', 'anugu-gallery-lite' )
            ),
            array(
                'value' => 'float_wrap',
                'name'  => __( 'Float (Wrapped)', 'anugu-gallery-lite' )
            ),
            array(
                'value' => 'inside',
                'name'  => __( 'Inside', 'anugu-gallery-lite' )
            ),
            array(
                'value' => 'outside',
                'name'  => __( 'Outside', 'anugu-gallery-lite' )
            ),
            array(
                'value' => 'over',
                'name'  => __( 'Over', 'anugu-gallery-lite' )
            )
        );

        return apply_filters( 'anugu_gallery_title_displays', $displays );
    ...
    public function get_arrows_positions() {
        ...
        return apply_filters( 'anugu_gallery_arrows_positions', $displays );
    ...
    public function get_transition_effects() {
        ...
        $effects = array(
            array(
                'value' => 'none',
                'name'  => __( 'No Effect', 'anugu-gallery-lite' )
            ),
            array(
                'value' => 'fade',
                'name'  => __( 'Fade', 'anugu-gallery-lite' )
            ),
            array(
                'value' => 'elastic',
                'name'  => __( 'Elastic', 'anugu-gallery-lite' )
            ),
        );

        return apply_filters( 'anugu_gallery_transition_effects', $effects );
    ...
    public function get_transition_effects_values() {
        ...
        // Return
        return apply_filters( 'anugu_gallery_transition_effects_values', $effect_values, $effects );
    ...
    public function get_easing_transition_effects() {
        ...
        $effects = array(
            array(
                'value' => 'Swing',
                'name'  => __( 'Swing', 'anugu-gallery-lite' )
            ),
        );

        return apply_filters( 'anugu_gallery_easing_transition_effects', $effects );
    ...
    public function get_toolbar_positions() {
        ...
        $positions = array(
            array(
                'value' => 'top',
                'name'  => __( 'Top', 'anugu-gallery-lite' )
            ),
            array(
                'value' => 'bottom',
                'name'  => __( 'Bottom', 'anugu-gallery-lite' )
            )
        );

        return apply_filters( 'anugu_gallery_toolbar_positions', $positions );
    ...
    public function get_thumbnail_positions() {
        ...
        return apply_filters( 'anugu_gallery_thumbnail_positions', $positions );
    ...
    public function get_config_defaults( $post_id ) {
      ...
      //     'mobile_columns'      => 1,
        ...
        $defaults = apply_filters( 'anugu_gallery_defaults', $defaults, $post_id );
    ...
    public function get_supported_filetypes() {
        ...
        $supported_file_types = array(
            array(
                'title'     => __( 'Image Files', 'anugu-gallery-lite' ),
        ...
        $supported_file_types = apply_filters( 'anugu_gallery_supported_file_types', $supported_file_types );
    ...
    public function get_supported_filetypes_mimes() {
        ...
        // Allow Developers and Addons to filter the supported file types
        $supported_file_types = apply_filters( 'anugu_gallery_supported_file_types_mimes', $supported_file_types );
    ...
    public function get_media_positions() {
        ...
        $positions = array(
            array(
                'value' => 'before',
                'name'  => __( 'Before Existing Images', 'anugu-gallery-lite' )
            ),
            array(
                'value' => 'after',
                'name'  => __( 'After Existing Images', 'anugu-gallery-lite' )
            ),
        );

        return apply_filters( 'anugu_gallery_media_positions', $positions );

    }

    /**
     * Returns an array of media deletion options, when an Anugu Gallery is deleted
     *
     * @since 1.3.5.1
     *
     * @return array
    ...
    public function get_media_delete_options() {
        ...
        $options = array(
            array(
                'value' => '',
                'name'  => __( 'No', 'anugu-gallery-lite' )
            ),
            array(
                'value' => '1',
                'name'  => __( 'Yes', 'anugu-gallery-lite' )
            ),
        );

        return apply_filters( 'anugu_gallery_media_delete_options', $options );
    ...
    public function resize_image( $url, $width = null, $height = null, $crop = true, $align = 'c', $quality = 100, $retina = false, $data = array(), $force_overwrite = false ) {
        ...
        // Filter args
        $args = apply_filters( 'anugu_gallery_resize_image_args', $args );
        ...
        if ( ! file_exists( $dest_file_name ) || ( file_exists( $dest_file_name ) && $force_overwrite ) ) {
            ...
            if ( is_wp_error( $editor ) ) {
                return new WP_Error( 'anugu-gallery-error-no-editor', __( 'No image editor could be selected. Please verify with your webhost that you have either the GD or Imagick image library compiled with your PHP install on your server.', 'anugu-gallery-lite' ) );
            }
        ...
        return apply_filters( 'anugu_gallery_resize_image_resized_url', $resized_url );
    ...
    public function get_image_info( $args ) {
        ...
        if ( empty( $url ) ) {
            return new WP_Error( 'anugu-gallery-error-no-url', __( 'No image URL specified for cropping.', 'anugu-gallery-lite' ) );
        }
        ...
        if ( ! file_exists( $file_path ) ) {
            return new WP_Error( 'anugu-gallery-error-no-file', __( 'No file could be found for the image URL specified.', 'anugu-gallery-lite' ) );
        }
        ...
        if ( ! $size ) {
            return new WP_Error( 'anugu-gallery-error-no-size', __( 'The dimensions of the original image could not be retrieved for cropping.', 'anugu-gallery-lite' ) );
        }
    ...
    public function flush_gallery_caches( $post_id, $slug = '' ) {
        ...
        do_action( 'anugu_gallery_flush_caches', $post_id, $slug );
     ...
     */
    public function get_transient_expiration_time( $plugin = 'anugu-gallery-lite' ) {

        // Define the default
        $default = DAY_IN_SECONDS;

        // Allow devs to filter this depending on the plugin
        $default = apply_filters( 'anugu_gallery_get_transient_expiration_time', $default, $plugin );
     ...
     * @since 1.0.0
     *
     * @return object The Anugu_Gallery_Common object.
     */
    public static function get_instance() {

        if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Anugu_Gallery_Common ) ) {
            self::$instance = new Anugu_Gallery_Common();
        }
...
$anugu_gallery_common = Anugu_Gallery_Common::get_instance();