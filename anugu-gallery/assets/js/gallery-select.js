 ...
 *      sidebar_view:           'anugu-selection-sidebar'  // WordPress media view to render into the sidebar
...
* @since 1.4.3.0
*/
wp.media.view.AnuguGalleryError = wp.Backbone.View.extend( {

    // The outer tag and class name to use. The item is wrapped in this
    tagName   : 'div',
    className : 'notice error anugu-gallery-error',

    render: function() {

        // Load the template to render
        // See includes/admin/media-views.php
        this.template = wp.media.template( 'anugu-gallery-error' );
...
* @since 1.5.0
*/
var AnuguGallerySelectionItemView = wp.Backbone.View.extend( {
    ...
    */
    template:   wp.template( 'anugu-selection-item' ),
...
* @since 1.5.0.3
*/
var AnuguGallerySelectionSidebarView = wp.Backbone.View.extend( {
    ...
    */
    initialize: function( view ) {
        ...
        this.view       = ( ( typeof view == 'undefined' ) ? 'anugu-selection-sidebar' : view );
...
*/
var AnuguGallerySelectionView = wp.Backbone.View.extend( {
    ...
    * - The template to load inside the above tagName element
    */
    template:   wp.template( 'anugu-selection' ),
    ...
    */
    initialize: function( args ) {
        ...
        // This must be a WordPress media view using e.g. <script type="text/html" id="tmpl-my-sidebar-view-name"> 
        this.sidebar_view       = ( ( typeof args.sidebar_view == 'undefined' ) ? 'anugu-selection-sidebar' : args.sidebar_view );
        ...
        this.insert_options = new Backbone.Model( {
            'modal_title':          ( ( typeof args.modal_title == 'undefined' ) ? anugu_gallery_select.modal_title : args.modal_title ),
            'title':                0,
            'insert_button_label':  ( ( typeof args.modal_title == 'undefined' ) ? anugu_gallery_select.insert_button_label : args.insert_button_label )
        } );
    ...
    */
    getItems: function( is_search, search_terms ) {
        ...
        this.$el.find( 'div.anugu-gallery-error' ).remove();
        ...
        switch ( this.action ) {
            case 'gallery':
                action = 'anugu_gallery_editor_get_galleries';
                break;
            case 'album':
                action = 'anugu_albums_editor_get_albums';
                break;
        }
        ...
        wp.media.ajax( action, {
            context: this,
            data: {
                nonce:          anugu_gallery_select.get_galleries_nonce,
                search:         is_search,
            ...
            success: function( items ) {
                ...
                this.collection.each( function( model ) {
                    ...
                    // Init with model
                    var child_view = new AnuguGallerySelectionItemView( {
                        model: model
                    } );
    ...
    */
    render: function() {
        ...
        var sidebar = new AnuguGallerySelectionSidebarView( this.sidebar_view );
    ...
    insert: function() {
        ...
        if ( typeof this.onInsert === 'undefined' ) {
            ...
            this.selection.forEach( function( item ) {
                ...
                // Shortcode
                shortcode += '[anugu-' + this.action + ' id="' + item.id + '"]';
            ...
            // Trigger the anuguGalleryModalData event, comprising of the chosen Galleries.
            jQuery( document ).trigger( { 
                type:   'anuguGalleryModalData', 
